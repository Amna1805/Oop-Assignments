...
class Employee:public Person
{
	...
	public:
		...
		Employee(char*n,float t_r,const Date&d);
		virtual ~Employee();
        ...
        virtual void display_calculate_salary() const=0;
...
Employee::Employee(char*n,float t_r,const Date&d):Person(n),dob(d)
{
	tax_rate=t_r;
}
...
class Salaried_Employee:public Employee
{
	...
	public:
		Salaried_Employee();
		Salaried_Employee(char*n,float tr,const Date&d,float salary);
		virtual ~Salaried_Employee();
	    void set_salary(float s);
		float get_salary() const;
		float calculate_salary() const;	
		virtual void display_calculate_salary() const;	
		virtual void print() const;	
};
...
Salaried_Employee::Salaried_Employee(char*n,float tr,const Date&d,float s):Employee(n,tr,d)
{
	salary=s;
}
...
class Hourly_Employee:public Employee
{
	...
	public:
	    Hourly_Employee();
	    Hourly_Employee(char*n,float tr,const Date&d,int h,float hr);
...
Hourly_Employee::Hourly_Employee(char*n,float tr,const Date&d,int h,float hr):Employee(n,tr,d)
{
	hours=h;
	hourly_rate=hr;
}
...
class Commission_Employee:public Employee
{
	...
	public:
		Commission_Employee();
	    Commission_Employee(char*n,float tr,const Date&d,float s ,float cr);
...
Commission_Employee::Commission_Employee(char*n,float tr,const Date&d,float s,float cr):Employee(n,tr,d)
{
	sales=s;
	commission_rate=cr;
}
